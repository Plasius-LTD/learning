# Contributing to @plasius/learning
...
`@plasius/learning` provides versioned, strongly typed learning-domain contracts, catalog validation, and deterministic assessment helpers. It deliberately excludes application and infrastructure adapters.

Contributions typically cover additive contract evolution, invariant validation, assessment behavior, catalog manifests, documentation, and tooling quality.
...
- `feat: add module publishing snapshot contract`
- `fix: reject duplicate assessment criteria`
- `docs: explain hardware manifest versioning`
- `refactor: simplify catalog validation`
- `test: add mandatory safety score cases`
- `chore: bump dev deps`
...
- Keep validation deterministic and free from infrastructure side effects.
- Preserve additive public compatibility unless a correctly versioned migration is approved.
